...
import 'actividades_f_s_model.dart';
export 'actividades_f_s_model.dart';

class ActividadesFSWidget extends StatefulWidget {
  const ActividadesFSWidget({super.key});

  @override
  State<ActividadesFSWidget> createState() => _ActividadesFSWidgetState();
}

class _ActividadesFSWidgetState extends State<ActividadesFSWidget>
    with TickerProviderStateMixin {
  late ActividadesFSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActividadesFSModel());
    ...
    return GestureDetector(
      ...
      child: Scaffold(
          ...
          child: Drawer(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(0.0, 40.0, 20.0, 20.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                  ...
                  children: [
                    ...
                    Material(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          FFLocalizations.of(context).getText(
                            'xmnotn2s' /* Configura tus datos de pago */,
                          ),
                          style:
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              'bkna27z7' /* Actividades disponibles */,
            ),
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'cm7c09cc' /* Filtra las actividades disponi... */,
                    ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    '3f89yg3q' /* Polideportivo Agustín Marañón */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelSmall
                                      .override(
                                ...
                                Padding(
                                  ...
                                  child: Semantics(
                                    label:
                                        'Botón Ver Horarios Disponibles Fútbol Sala',
                                    child: FFButtonWidget(
                                      onPressed: () {
                                        print('Button pressed ...');
                                      },
                                      text: FFLocalizations.of(context).getText(
                                        '8rbjwion' /* Ver Horarios Disponibles */,
                                      ),
                                      options: FFButtonOptions(
                                        height: 35.0,
                                        padding: const EdgeInsetsDirectional.fromSTEB(
