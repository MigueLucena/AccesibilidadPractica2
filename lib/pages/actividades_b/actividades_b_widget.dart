...
import 'actividades_b_model.dart';
export 'actividades_b_model.dart';

class ActividadesBWidget extends StatefulWidget {
  const ActividadesBWidget({super.key});

  @override
  State<ActividadesBWidget> createState() => _ActividadesBWidgetState();
}

class _ActividadesBWidgetState extends State<ActividadesBWidget>
    with TickerProviderStateMixin {
  late ActividadesBModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActividadesBModel());
    ...
    return GestureDetector(
      ...
      child: Scaffold(
                  ...
                  InkWell(
                    ...
                    child: Material(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          FFLocalizations.of(context).getText(
                            'ax6bym9x' /* Configura tus datos de pago */,
                          ),
                          style:
                              FlutterFlowTheme.of(context).labelMedium.override(
                                    fontFamily: 'Inter',
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              '11g0jkhr' /* Actividades disponibles */,
            ),
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'v6qk1c2e' /* Filtra las actividades disponi... */,
                    ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'j621o4c6' /* Polideportivo Agustín Marañón */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelSmall
                                      .override(
                                ...
                                Padding(
                                  ...
                                  child: Semantics(
                                    ...
                                    child: FFButtonWidget(
                                      ...
                                      text: FFLocalizations.of(context).getText(
                                        'phz7oiqk' /* Ver Horarios Disponibles */,
                                      ),
                                      options: FFButtonOptions(
                                        height: 35.0,
                                        padding: const EdgeInsetsDirectional.fromSTEB(
