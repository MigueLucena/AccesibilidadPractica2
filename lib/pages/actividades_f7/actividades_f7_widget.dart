...
import 'actividades_f7_model.dart';
export 'actividades_f7_model.dart';

class ActividadesF7Widget extends StatefulWidget {
  const ActividadesF7Widget({super.key});

  @override
  State<ActividadesF7Widget> createState() => _ActividadesF7WidgetState();
}

class _ActividadesF7WidgetState extends State<ActividadesF7Widget>
    with TickerProviderStateMixin {
  late ActividadesF7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActividadesF7Model());
    ...
    return GestureDetector(
      ...
      child: Scaffold(
                  ...
                  InkWell(
                    ...
                    child: Material(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          FFLocalizations.of(context).getText(
                            'whgue0t1' /* Configura tus datos de pago */,
                          ),
                          style:
                              FlutterFlowTheme.of(context).labelMedium.override(
                                    fontFamily: 'Inter',
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              'lppm6r05' /* Actividades disponibles */,
            ),
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'u4h11iet' /* Filtra las actividades disponi... */,
                    ),
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'b1t5p79z' /* Polideportivo Agustín Marañón */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelSmall
                                      .override(
                                ...
                                Padding(
                                  ...
                                  child: Semantics(
                                    ...
                                    child: FFButtonWidget(
                                      ...
                                      text: FFLocalizations.of(context).getText(
                                        'suxo4m3v' /* Ver Horarios Disponibles */,
                                      ),
                                      options: FFButtonOptions(
                                        height: 35.0,
                                        padding: const EdgeInsetsDirectional.fromSTEB(
