                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'atdo6ffq' /* Rellena la información para cr... */,
                                  ),
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode:
                                        _model.createEmailAddressFocusNode,
                                    autofocus: true,
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    Function() navigate = () {};
                                    _model.validationRegister = true;
                                    if (_model.formKey.currentState == null ||
                                        !_model.formKey.currentState!
                                            .validate()) {
                                      _model.validationRegister = false;
                                    }
                                    if (_model.validationRegister!) {
                                      if (functions.validationFunction(
                                          _model.createPasswordTextController
                                              .text,
                                          _model.confirmPasswordTextController
                                              .text)!) {
                                        ...
                                        final user = await authManager
                                          ...
                                          context,
                                          _model
                                              .createEmailAddressTextController
                                              .text,
                                          _model.createPasswordTextController
                                              .text,
                                        );
